...
SURUM = "v23.23-2026.06.01"   # Canli log teshisi: sahte indirim uretimi kaldirildi (aciliyet kelimesi artik %50 uydurmuyor) + KURTARMA urunleri artik paylasiliyor (kurtarilan ad sablona iletiliyor)
